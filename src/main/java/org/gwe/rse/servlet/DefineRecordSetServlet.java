 ...
 * @since Dec 13, 2008
 */
public class DefineRecordSetServlet extends BrowserServlet {

	public static final String URI = "/define";

    protected String getOutput(Map<String, String> params, RecordSetProviderRepo repo) throws ServletException {
		try {
	        return getVelocityTemplate().evaluate(null, repo, new HashMap<String, Object>());
        } catch (Exception e) {
